...
class FacturacionModerna {
  ...
  * @return void
  */
	public function timbrar($str, $opciones = array('generarCBB' => false, 'generarTXT' => false, 'generarPDF' => true)){
    ...
    try {
      ...
      if(isset($respuesta->xml)){
        ...
        $xml_cfdi->registerXPathNamespace("tfd", "http://www.sat.gob.mx/TimbreFiscalDigital");//modificado17112016
